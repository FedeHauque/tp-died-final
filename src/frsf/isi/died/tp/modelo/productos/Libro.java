...
public class Libro extends MaterialCapacitacion {
	...
	public Libro(Integer id, String titulo, Double costo, Double precioCompra, Integer paginas, Integer calificacion, Date fechaPublicacion, Relevancia relevancia, String tema) {
