...
public class AristaGUI {
    ...
    private VerticeGUI origen;
    private VerticeGUI destino;
    private Shape linea;
 ...
 hacia la coordenada destino de la linea, tomando como base el color destino de la linea
    ...
    public Stroke getFormatoLinea() {
        if(this.formatoLinea==null)  {
            this.formatoLinea = new BasicStroke(2, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND);
            //this.formatoLinea = new BasicStroke(3);
        }       
        return formatoLinea;
    }
    ...
    public VerticeGUI getOrigen() {
        return origen;
    }

    public void setOrigen(VerticeGUI origen) {
        this.origen = origen;
    }

    public VerticeGUI getDestino() {
        return destino;
    }

    public void setDestino(VerticeGUI destino) {
